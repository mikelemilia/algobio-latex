...
\item[-] una funzione di Min che per ogni query allo Sketch che richiede il conteggio stimato di un evento di tipo $i$, ritorna il valore minimo nella tabella per $i$, ovvero: $$\hat{a}_i = \min_{j} count[\ j,\ h_j (i)\ ]$$
