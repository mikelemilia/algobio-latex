...
\begin{figure}[h!]
	\centering
  	...
  	\caption{ Influenza della dimensione degli indel sul richiamo raggiunto dai quattro strumenti considerati sul set \texttt{FullGenome}:
l'istogramma mostra la distribuzione della frequenza (su scala logaritmica) degli indel rispetto alla loro lunghezza; Il grafico a dispersione mostra il richiamo degli strumenti rispetto alla dimensione.}
