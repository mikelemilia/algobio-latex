...
\item MALVA (sezione \ref{malva}): questo metodo \cite{bernardini2019malva} \ in grado di genotipizzare SNP e indel multi-allelici, anche in regioni del genoma ad alta densità, e di gestire efficacemente un numero grande di varianti.
