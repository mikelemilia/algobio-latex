...
%\paragraph{Strategie per identificare variazioni} È ormai chiaro che l'analisi delle bolle all'interno di un grafo di \textit{de Bruijn} risulta cruciale per riuscire a comprenderne il loro contenuto informativo. In letteratura, \cite{leggett2014reference} presentano alcune strategie basate sui grafi \textit{de Bruijn} per identificare mutazioni.\\
%
%\subparagraph{DF} 
%
%\subparagraph{Topologica}
%
%\subparagraph{Microassembly}
%
%\subparagraph{MLE} Maxumim Likelihood Method
%
%\subparagraph{Contig Based Graph}
%
%\textcolor{red}{Credo sia troppo aggiungere questa parte}
